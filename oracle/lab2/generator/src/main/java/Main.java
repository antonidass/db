...
public class Main {
    ...
    public static void createStockMarket() throws IOException, CsvException {
        String company = "market.csv";
        CSVWriter writer = new CSVWriter(new FileWriter(company));

        CSVReader readerCompany = new CSVReader(new FileReader("company.csv"));
        String[] sex = {"YES", "NO"};
    ...
    public static void createStocksExchange() throws IOException, CsvException {
        String company = "stock_exchange.csv";
        CSVWriter writer = new CSVWriter(new FileWriter(company));

        CSVReader readerCompany = new CSVReader(new FileReader("stock_exchange.csv"));
        String[] sex = {"YES", "NO"};
